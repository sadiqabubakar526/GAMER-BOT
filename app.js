...
intents.onDefault([
    function (session) {
        session.send("Hi there, I am GAMER-BOT, a bot that plays Connect Four game with you. Click here https://bots.botframework.com/bot?id=c4bot to find out more about me and my policies.");
...
bot.dialog('/help', [
    function (session) {
        ...
        session.send(msg);
        session.send("If you encounter any issue, please report it to my GitHub repo: https://github.com/sadiqabubakar526/GAMER-BOT/issues");
        session.endDialog();
    }
]);
bot.dialog('/new', [
